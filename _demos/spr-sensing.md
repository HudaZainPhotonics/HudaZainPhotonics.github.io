...
<nav class="spr-section-nav" aria-label="Demo sections">
...
<div class="spr-grid">
  <div class="spr-panel">
    ...
    <p class="spr-caption">TM-polarized monochromatic light · BK7 / Au / analyte</p>
    <div class="spr-setup">
      <div class="spr-prism"></div>
      <div class="spr-prism-label">BK7 prism<br><span style="font-weight:400">n = 1.51</span></div>
      <div class="spr-gold"></div><div class="spr-gold-label">Au film · 50 nm</div>
      <div class="spr-analyte"></div><div class="spr-analyte-label">analyte · <span id="schematicRI">n = 1.328</span></div>
      <div class="spr-interface"></div>
      <div id="beamIn" class="spr-beam spr-in"></div>
      <div id="beamOut" class="spr-beam spr-out"></div>
      <div class="spr-beam-dot"></div>
      <div id="angleLabel" class="spr-angle-label">θ = 66.0°</div>
      <div id="spWave" class="spr-sp-wave">
      ...
      <div class="spr-sp-label">surface-plasmon coupling (schematic)</div>
      <div class="spr-setup-note">
  ...
  <div class="spr-panel spr-plot-wrap">
    <h3>Angular reflectivity</h3>
    <p class="spr-caption"><strong>Optical observable:</strong> reflected power, R &nbsp;·&nbsp; Faint dashed: reference at n = 1.328 RIU</p>
    <div id="sprPlot"></div>
    <div class="spr-readouts">
      <div class="spr-readout"><span>Selected angle</span><strong id="selectedAngle">66.000°</strong></div>
      <div class="spr-readout"><span>Reflectivity at selected angle</span><strong id="selectedR">—</strong></div>
      <div class="spr-readout"><span>Resonance angle</span><strong id="resAngle">—</strong></div>
    </div>
  </div>
</div>

<div class="spr-controls">
  <div class="spr-control">
    <strong>Incident angle, θ</strong>
    <input id="angle" type="range" min="60" max="75" step="0.02" value="66">
    <div class="spr-value"><span id="angleValue">66.00</span>°</div>
  </div>
  <div class="spr-control">
    <strong>Analyte refractive index</strong>
    <input id="ri" type="range" min="1.328" max="1.350" step="0.001" value="1.328">
    <div class="spr-value"><span id="riValue">1.328</span> <small>RIU</small></div>
  </div>
  <label class="spr-check"><input id="showTE" type="checkbox"> Show TE comparison</label>
</div>

<div class="spr-lesson">
...
<section class="spr-interrogation" id="interrogation">
<h2>2. How Should We Interrogate the Resonance?</h2>
<p class="spr-caption">For each method, compare the optical SPR response with the corresponding refractive-index calibration. Sensitivity is the local slope of that calibration.</p>
<nav class="spr-jumpbar">
<a href="#angular-method">Angular</a>
<a href="#wavelength-method">Wavelength</a>
<a href="#intensity-method">Intensity</a>
</nav>

<section class="spr-method" id="angular-method">
<h3>Angular interrogation</h3>
<p class="spr-caption">Sensor output: resonance angle, θ<sub>SPR</sub>, at a fixed wavelength.</p>

<div class="spr-method-grid">
  <div class="spr-figurebox">
    <strong>Five RI states: angular SPR response, R versus angle</strong>
    <div id="angResponse" class="spr-methodplot"></div>
  </div>

  <div class="spr-figurebox">
    <strong>Extract each dip minimum: θ<sub>SPR</sub> versus refractive index</strong>
    <div id="angCalibration" class="spr-methodplot"></div>
  </div>
</div>

<div class="spr-method-control">
  <strong>Analyte refractive index</strong>
  <input id="angRI" type="range" min="1.328" max="1.344" step="0.004" value="1.344">
  <strong id="angRIValue">1.344 RIU</strong>
</div>

<div class="spr-method-values">
...
<section class="spr-method" id="wavelength-method">
<h3>Wavelength interrogation</h3>
<p class="spr-caption">Sensor output: resonance wavelength, λ<sub>SPR</sub>, at a fixed incidence angle.</p>
<div class="spr-method-grid">
<div class="spr-figurebox"><strong>Five RI states: spectral SPR response, R versus wavelength</strong><div id="waveResponse" class="spr-methodplot"></div></div>
<div class="spr-figurebox"><strong>Extract each dip minimum: λ<sub>SPR</sub> versus refractive index</strong><div id="waveCalibration" class="spr-methodplot"></div></div>
</div>
<div class="spr-method-control">
  <strong>Analyte refractive index</strong>
...
<section class="spr-method" id="intensity-method">
<h3>Intensity interrogation</h3>
<p class="spr-caption">Sensor output: reflectivity at one fixed operating angle, R(θ<sub>op</sub>).</p>
<div class="spr-method-grid">
<div class="spr-figurebox"><strong>Five RI states: angular SPR response, R versus angle</strong><div id="intResponse" class="spr-methodplot"></div></div>
<div class="spr-figurebox"><strong>Sample each revealed curve at fixed θ<sub>op</sub>: R versus refractive index</strong><div id="intCalibration" class="spr-methodplot"></div></div>
</div>
<div class="spr-method-control">
  <strong>Analyte refractive index</strong>
...
<p class="spr-method-note">The n = 1.328 RIU curve remains the dashed reference. As the selected RI increases, only intermediate states up to that value are revealed. The dots where θop intersects those curves are the same points used to build the R-versus-n calibration on the right. Intensity sensitivity is calculated from neighboring visible calibration points; the readout also flags whether the revealed calibration is monotonic or non-monotonic.</p>
</section>

<div class="spr-compare-strip">Same SPR interaction → angular, intensity, or wavelength readout → different calibration and sensitivity.</div>
</section>


<section class="spr-sensor-design" id="sensor-design">
  <div class="spr-design-banner">
  ...
  <div class="spr-design-subsection">
    <h3>Sensing range</h3>
    <p class="spr-caption">
    ...
    <div class="spr-design-controls">
      <strong>Analyte refractive index</strong>
      <input id="designRI" type="range" min="1.328" max="1.360" step="0.004" value="1.360">
      <strong id="designRIValue">1.360 RIU</strong>
    </div>

    <div class="spr-design-grid">
      <div class="spr-design-card">
        <h3>Angular interrogation</h3>
        <p class="spr-caption">Finite angular scan window: 64–70°.</p>
        <div id="designAngularRange" class="spr-designplot"></div>
        <div class="spr-design-values">
      ...
      <div class="spr-design-card">
        <h3>Wavelength interrogation</h3>
        <p class="spr-caption">Finite spectral window: 700–900 nm.</p>
        <div id="designWaveRange" class="spr-designplot"></div>
        <div class="spr-design-values">
  ...
  <div class="spr-design-subsection">
    ...
    <div class="spr-resolution-stack">
      <h3>Angular resolution</h3>
      <p class="spr-caption">Can an angular interrogator distinguish the RI-induced resonance shift?</p>
      <div class="spr-resolution-grid">
        <div class="spr-resolution-figure">
          <strong>Ideal angular response</strong>
          <div id="angularIdealPlot" class="spr-resolution-plot"></div>
        </div>
        <div class="spr-resolution-figure">
          <strong>Resolved by the instrument</strong>
          <div id="angularResolvedPlot" class="spr-resolution-plot"></div>
        </div>
        <div class="spr-resolution-figure">
          <strong>Consequence: RI measurement error</strong>
          <div id="angularConsequencePlot" class="spr-resolution-plot"></div>
        </div>
      </div>
      <div class="spr-design-controls">
    ...
    <div class="spr-resolution-stack">
      ...
      <p class="spr-caption">Can a spectral interrogator distinguish the RI-induced resonance shift?</p>
      <div class="spr-resolution-grid">
        <div class="spr-resolution-figure">
          <strong>Ideal spectral response</strong>
          <div id="waveIdealPlot" class="spr-resolution-plot"></div>
        </div>
        <div class="spr-resolution-figure">
          <strong>Resolved by the instrument</strong>
          <div id="waveResolvedPlot" class="spr-resolution-plot"></div>
        </div>
        <div class="spr-resolution-figure">
          <strong>Consequence: RI measurement error</strong>
          <div id="waveConsequencePlot" class="spr-resolution-plot"></div>
        </div>
      </div>
      <div class="spr-design-controls">
        <strong>RI change from 1.328 RIU</strong>
...
<section class="spr-application-section" id="application">
  <div class="spr-application-banner">
  ...
  <div class="spr-application-grid">
    <div class="spr-application-card">
      <h3>1. Molecular binding</h3>
      <p class="spr-caption">A functionalized Au surface uses immobilized biorecognition elements to selectively bind the target analyte.</p>
      <div id="bioSurface" class="spr-bio-surface">
        <div class="spr-bio-liquid"></div>
        <div class="spr-bio-gold"></div>
        <div class="spr-bio-label" style="left:9%;top:34px">sample / analyte</div>
        <div class="spr-bio-label" style="left:9%;bottom:42px">Au sensing surface</div>
      </div>
      <p class="spr-caption" style="margin-top:8px"><strong>Binding → local surface Δn</strong></p>
    </div>

    <div class="spr-application-card">
      <h3>2. Optical resonance shift</h3>
      <p class="spr-caption">The local refractive-index change shifts the angular SPR resonance.</p>
      <div id="bioAnglePlot" class="spr-application-plot"></div>
      <p class="spr-caption" style="margin-top:8px"><strong>Δn → Δθ<sub>SPR</sub></strong></p>
    </div>

    <div class="spr-application-card">
      <h3>3. Binding response</h3>
      <p class="spr-caption">The measured resonance shift evolves during association and dissociation.</p>
      <div id="sensorgramPlot" class="spr-application-plot"></div>
      <p class="spr-caption" style="margin-top:8px"><strong>Δθ<sub>SPR</sub>(t) → sensorgram</strong></p>
    </div>
  </div>

  <div class="spr-application-controls">
  ...
  <div class="spr-application-values">
  ...
  <div class="spr-kinetics-section" id="binding-kinetics">
    ...
    <div class="spr-kinetics-grid">
      <div class="spr-kinetics-card">
        <h3>1. Molecular binding state</h3>
        <p class="spr-caption">The surface view follows the selected time on the sensorgram.</p>
        <div id="kineticsSurface" class="spr-kinetics-surface">
          <div class="spr-kinetics-liquid"></div>
          <div class="spr-kinetics-gold"></div>
        </div>
        <div class="spr-kinetics-phase" id="kineticsPhase">baseline</div>
      </div>

      <div class="spr-kinetics-card">
        <h3>2. 1:1 binding model</h3>
        <p class="spr-caption">Association forms AR; dissociation returns the complex to free analyte and receptor.</p>
        <div class="spr-kinetics-mechanism">
          A + R ⇌ AR
        </div>
      ...
      <div class="spr-kinetics-card">
        <h3>3. Sensorgram</h3>
        <p class="spr-caption">The marker and molecular surface move together through baseline, association, and dissociation.</p>
        <div id="kineticsPlot" class="spr-kinetics-plot"></div>
      </div>
    </div>

    <div class="spr-kinetics-controls">
